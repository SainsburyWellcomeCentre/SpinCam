    ...
    methods (Access = private)
        ...
        function buildRecordingTab(obj, tab)
            ...
            obj.Ui.Format = uidropdown(f, 'Items', formatLabels(), 'ItemsData', spincam.VideoRecorder.Formats, ...
                ...
                'Tooltip', ['avi-mjpeg: compact, ≤ ~100 fps per camera. raw: lossless, any frame rate (convert with ' ...
...
labels = {'avi-mjpeg · MJPEG AVI (native)', 'avi-raw · uncompressed AVI (native)', ...
